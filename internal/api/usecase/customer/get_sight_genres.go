...
type GetSightGenresInputPort interface {
	Execute(ctx context.Context, operator *model.Customer, name string, sightCategoryID, offset, limit uint64) (*GetSightGenresOutput, error)
}
...
func (i *GetSightGenresInteractor) Execute(ctx context.Context, customer *model.Customer, name string, sightCategoryID, offset, limit uint64) (*GetSightGenresOutput, error) {
	if customer == nil {
